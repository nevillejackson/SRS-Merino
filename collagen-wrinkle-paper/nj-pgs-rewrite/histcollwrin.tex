...
The data can not be pixel counts, because they are not intwgers. 
They must be something like counts weighted by the intensity of redness of each pixel, or something similar.
