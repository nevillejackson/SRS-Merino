...
\input{tabmeans.tex}
All four traits ( Follicle depth, straight follicle length, curved follicle length, and radius of curvature) would appear to differ substantially between loose and wrinkly Skintypes, but the two Flocks would seem to be similar.
